...
class Video:
    def __int__(self, title, duration, adult_mode=False):
        self.title = title
    ...
    def __repr__(self):
        return f'Video(title={self.title}, duration={self.duration} sec)'
        ...
        for video in self.videos:
            if title == video.title:
                if video.adult_mode and self.current_user.age >= 18:
                    ...
                    print("Bам нет 18 лет, пожалуйста покиньте страницу")
                break
